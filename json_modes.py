...
line_art = {
    ...
    '19': {
        'inputs': {
            'text': '1girl,cat ears, tail, greyscale,monochrome,line art, black and white, clean, complete drawing, completed, long lines, long strokes',
            'clip': ['37', 1]
        },
        'class_type': 'CLIPTextEncode'
    },
    ...
    '38': {
        'inputs': {
            'lora_name': 'sd2ly_line.safetensors',
            'strength_model': 0.8,
            'strength_clip': 0.25,
            'model': ['18', 0],
            'clip': ['18', 1]
