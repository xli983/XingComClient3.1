...
async def input_loop():
    ...
    while True:
        if shared.method_called_flag:
            ...
            number = 1
            extra_data = {}
            shared.method_called_flag = False
...
# import execution, comfy.model_management
    ...
    try:
        p = Process(target=start_asyncio_loop)
        p.start()
